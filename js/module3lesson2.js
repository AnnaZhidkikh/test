...
//  if (user.access?.role) { // тоже самое что if (user.access && user.access.role)
// console.log(role)
// }
...
// id - уникальный идентификатор, это может быть new Date(), или рандомное число или индекс массива.
        const transaction = {
            type,
            amount: amountNumber,
   ...
   if (error) return `Error: ${transaction}`
